      ...
      <div class="row">
        ...
        <div class="span9">
            <h1 class="heading1">
              ...
              <div class="checkoutsteptitle">PESAN PADA : <?=$this->dateid->date_encode($order_beranda['created_at'])?> (TOTAL : Rp<?=$this->cart->format_number($order_beranda['total_harga'])?>,-)<a class="modify">RESI : <?=$order_beranda['resi']?></a></div>
